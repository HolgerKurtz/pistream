...
def run(socket: zmq.Socket, tracker: BirdTracker, state: AppState) -> None:
    frame_count = 0
    ...
    try:
        while True:
            ...
            # One lock acquisition gives a consistent view of all tunable params
        ...
        logger.error(f"ZMQ loop crashed: {e}", exc_info=True)
